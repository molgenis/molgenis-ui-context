  ...
  methods: {
    ...
    handleResize () {
      if (this.showHamburger) {
        ...
        console.log('actualNavHeight', actualNavHeight)
        console.log('heightBreakPoint', heightBreakPoint)
        console.log('expectedNavHeight', this.expectedNavHeight)
        console.log('wrapMargin', this.wrapMargin)
